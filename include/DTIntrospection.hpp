 ...
 * @brief A class for introspecting decision trees, providing various utilities for recursive descent, display, and explanation.
 * 
 * This class provides methods to recursively traverse decision trees, display training samples, and explain classifications.
 * It also includes utility functions for feature value combinations and mappings between samples and nodes.
 * 
 * @public
 * @method getShared
